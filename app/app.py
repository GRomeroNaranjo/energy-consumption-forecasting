...
data_x_1 = data_x[140000:]
data_y_1 = data_y[140000:]

tools = Tools(config)
tools.train(300, data_x_1, data_y_1)
tools.train_accuracy(data_x_1, data_y_1)

X_train, X_test, y_train, y_test = train_test_split(data_x, data_y, test_size=0.001, random_state=42)
test_accuracy_individual(X_train, y_train, X_test, y_test, config, 20)
